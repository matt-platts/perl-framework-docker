...
our $path 			= "portal-api"; # must not include leading or trailing slashes. This *must* be correct or nothing will work. It should relate to the URL called (no cgi-bins reqd unless part of the url).
